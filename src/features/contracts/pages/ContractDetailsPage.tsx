...
import { calculateDuration } from '@/shared/utils/contractUtils';
              ...
              <CardContent className="space-y-3 pt-4">
                <div>
                  ...
                  <p className="text-base font-semibold">
                    {getValue(contract.customer?.name)}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-base font-mono">
                    {getValue(contract.customer?.passportNumber)}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium text-muted-foreground">
                  ...
                  <p className="text-base font-mono">
                    {getValue(contract.customer?.driverLicenseNumber)}
                  </p>
                </div>
              ...
              <CardContent className="space-y-3 pt-4">
                ...
                <div>
                  ...
                  <p className="text-base font-mono font-bold">
                    {getValue(contract.car?.licensePlate)}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium text-muted-foreground">
                  ...
                  <p className="text-base">
                    {getValue(contract.car?.manufacturer)}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium text-muted-foreground">
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-l-4 border-l-purple-500">
              ...
              <CardContent className="space-y-3 pt-4">
                ...
                <div>
                  ...
                  <p className="text-base font-semibold">
                    {calculateDuration(contract.startDate, contract.endDate) > 0
                      ? `${calculateDuration(
                          contract.startDate,
                          contract.endDate
                        )} dana`
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Da li ste sigurni da želite obrisati ovaj ugovor? Ova akcija se ne
              može poništiti.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
