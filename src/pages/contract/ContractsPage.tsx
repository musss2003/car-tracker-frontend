...
import { getContracts, deleteContract, downloadContract } from "@/services/contractService"
                          ...
                          <TableCell>
                            <div className="flex items-center gap-2">
                              <Avatar className="h-8 w-8">
                                <AvatarFallback>{contract.customer?.name?.charAt(0) || "?"}</AvatarFallback>
                              </Avatar>
            ...
            <AlertDialogDescription>
              ...
              {contractToDelete && (
                <span className="font-medium">
                  {" "}
                  for {contractToDelete.customer?.name} that rented ({contractToDelete.car?.manufacturer}) ({contractToDelete.car?.model}) in the period from{" "}
