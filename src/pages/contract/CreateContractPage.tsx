...
import { AlertCircle, Calendar, FileText, Loader2, PlusCircle, Truck, User, X, DollarSign } from "lucide-react"
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const contractData: ContractFormData = {
        ...
        dailyRate: formData.dailyRate !== undefined ? Number.parseFloat(String(formData.dailyRate)) : 0,
        totalAmount: formData.totalAmount !== undefined ? Number.parseFloat(String(formData.totalAmount)) : 0,
        ...
        <div className="mx-auto p-4">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end">
              <Button type="submit" disabled={isSubmitting} size="lg" className="flex items-center gap-2">
                {isSubmitting ? (
                  <>
