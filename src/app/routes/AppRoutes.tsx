...
const RegisterPage = lazy(() => import('../../features/auth/pages/RegisterPage/RegisterPage'));

// Cars Pages - Feature-based imports
const CarsPage = lazy(() => import('../../features/cars/pages/CarsPage'));
const CreateCarPage = lazy(() => import('../../features/cars/pages/CreateCarPage'));
const EditCarPage = lazy(() => import('../../features/cars/pages/EditCarPage'));
const CarDetailsPage = lazy(() => import('../../features/cars/pages/CarDetailsPage'));
const CarAvailabilityPage = lazy(() => import('../../features/cars/pages/CarAvailabilityPage'));
...
const UserProfile = lazy(() => import('../../features/users/components/UserProfile/UserProfile'));

// Shared Pages
const ShadcnExamplesPage = lazy(() => import('../../shared/pages/ShadcnExamplesPage'));
